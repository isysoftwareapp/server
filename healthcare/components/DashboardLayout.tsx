...
export default function DashboardLayout({
  ...
  const navigation = [
    ...
    },
    {
      ...
      roles: ["Admin", "Director", "Finance", "Reception"],
    },
    {
      name: "Inventory",
      href: "/dashboard/inventory",
      icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4",
      roles: ["Admin", "Director", "Pharmacy", "Laboratory", "Radiology"],
    },
    {
      name: "Laboratory",
      href: "/dashboard/laboratory",
      icon: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z",
      roles: ["Admin", "Director", "Laboratory", "Doctor"],
    },
    {
      name: "Radiology",
      href: "/dashboard/radiology",
      icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z",
      roles: ["Admin", "Director", "Radiology", "Doctor"],
    },
    {
      name: "Pharmacy",
      href: "/dashboard/pharmacy",
      icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10",
      roles: ["Admin", "Director", "Pharmacy", "Doctor"],
    },
    {
      name: "Reports",
    ...
    {
      name: "Pricelists",
      href: "/dashboard/pricelists",
      icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
      roles: ["Admin", "Director", "Finance", "Operational"],
    },
    {
      name: "Clinics",
      href: "/dashboard/clinics",
      icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4",
      roles: ["Admin", "Director", "Operational"],
    },
    {
      name: "Practitioners",
      href: "/dashboard/practitioners",
      icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",
      roles: ["Admin", "Director", "Operational", "Reception"],
    },
    {
      name: "Users",
  ...
  // Filter navigation based on user role, or show all if role is missing (fallback)
